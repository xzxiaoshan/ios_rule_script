...
方法一手机：开启抓包, 网页登录 https://m.iqiyi.com/user.html 返回抓包APP搜索URL关键字 apis/profile/info.action 复制请求头中的Cookie字段填入以下脚本变量或环境变量中即可
...
[task_local]
# 爱奇艺会员签到
0 9 * * * https://raw.githubusercontent.com/xzxiaoshan/ios_rule_script/develop/script/iqiyi/iQIYI.js
[rewrite_local]
# 获取Cookie
^https:\/\/passport\.iqiyi\.com\/apis\/profile\/info\.action url script-request-header https://raw.githubusercontent.com/xzxiaoshan/ios_rule_script/develop/script/iqiyi/iQIYI.js
[mitm]
...
**********************
[Script]
爱奇艺签到 = type=cron,cronexp=0 9 * * *,timeout=120,script-path=https://raw.githubusercontent.com/xzxiaoshan/ios_rule_script/develop/script/iqiyi/iQIYI.js
爱奇艺获取Cookie = type=http-request,pattern=^https:\/\/passport\.iqiyi\.com\/apis\/profile\/info\.action,script-path=https://raw.githubusercontent.com/xzxiaoshan/ios_rule_script/develop/script/iqiyi/iQIYI.js
[MITM]
hostname= passport.iqiyi.com
************************
Loon 2.1.0+ 脚本配置:
...
[Script]
# 爱奇艺签到
cron "0 9 * * *" script-path=https://raw.githubusercontent.com/xzxiaoshan/ios_rule_script/develop/script/iqiyi/iQIYI.js
# 获取Cookie
http-request ^https:\/\/passport\.iqiyi\.com\/apis\/profile\/info\.action script-path=https://raw.githubusercontent.com/xzxiaoshan/ios_rule_script/develop/script/iqiyi/iQIYI.js
[Mitm]
hostname= passport.iqiyi.com
*/
...
function GetCookie() {
  if (!$request.url.includes("/apis/profile/info.action")) {
